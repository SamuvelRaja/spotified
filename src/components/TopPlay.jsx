...
const TopPlay = () => (
  <div className="flex gap justify-between items-center py-4">
    ...
    <div className="flex items-center gap-2">
      ...
      <div className="rounded-full bg-[#0000008a] w-[32px] h-[32px] p-2"><img src={spot} alt="" className="w-[16px] h-[16px]" /></div>
    </div>
  </div>
);
